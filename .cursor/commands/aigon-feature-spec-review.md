...
- Do not run `aigon feature-spec-revise <name>` — that is a different command for a later stage, run by the feature author after reviewers have submitted. It is not your job here.
