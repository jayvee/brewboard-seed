...
- Do not run `aigon research-spec-revise $1` — that is a different command for a later stage, run by the research author after reviewers have submitted. It is not your job here.
